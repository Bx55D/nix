...
static uint32_t vertical_padding = 10;
...
static pixman_color_t active_fg_color = HEX_COLOR(0xe6e9efff);
static pixman_color_t active_bg_color = HEX_COLOR(0x1e1e2eff);
static pixman_color_t occupied_fg_color = HEX_COLOR(0xe6e9efff);
static pixman_color_t occupied_bg_color = HEX_COLOR(0x33334eff);
static pixman_color_t inactive_fg_color = HEX_COLOR(0xe6e9efff);
static pixman_color_t inactive_bg_color = HEX_COLOR(0x33334eff);
static pixman_color_t urgent_fg_color = HEX_COLOR(0x222222ff);
static pixman_color_t urgent_bg_color = HEX_COLOR(0xc1c1d7ff);
static pixman_color_t middle_bg_color = HEX_COLOR(0x33334eff);
static pixman_color_t middle_bg_color_selected = HEX_COLOR(0x33334eff);
